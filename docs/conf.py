...
# ones.
extensions = [
    'sphinx.ext.autodoc', 'sphinx_autodoc_typehints', 'sphinx.ext.todo', 'sphinx.ext.mathjax',
    'sphinx.ext.viewcode', 'sphinx.ext.napoleon', 'm2r'
]
...
latex_documents = [
    (master_doc, project + '.tex', project + ' Documentation', 'Fausto Morales', 'manual'),
]
